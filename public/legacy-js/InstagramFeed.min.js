            ...
            if (4 === c.readyState)
              if (200 === c.status) {
                ...
                if ("undefined" == typeof b) {
                  var f = localStorage.getItem(d.cache_data_key);
                  if (
                    (null !== f && ((b = JSON.parse(f)), (e = !0)),
                    d.options.on_error(
                    ...
                    return;
                } else b = b[0].graphql.user || b[0].graphql.hashtag;
                !e &&
                  0 < d.options.cache_time &&
                  (localStorage.setItem(d.cache_data_key, JSON.stringify(b)),
                  localStorage.setItem(
                    d.cache_data_key_cached,
                    new Date().getTime()
                  )),
                  a(b, d);
              } else
        ...
        (this.display = function (b) {
          ...
          if (
            ...
            if ("undefined" != typeof b.is_private && !0 === b.is_private)
              ...
              var h = (
                b.edge_owner_to_timeline_media || b.edge_hashtag_to_media
              ).edges;
              (p =
                h.length > this.options.items ? this.options.items : h.length),
        ...
        (this.run = function () {
          ...
          if (
            ((this.cache_data_key =
              ...
              (this.is_tag
                ? "t_" + this.options.tag
                : "u_" + this.options.username)),
            (this.cache_data_key_cached = this.cache_data_key + "_cached"),
            0 < this.options.cache_time)
          ) {
            var b = localStorage.getItem(this.cache_data_key_cached);
            if (
              null !== b &&
              parseInt(b) + 60000 * this.options.cache_time >
                new Date().getTime()
            ) {
              var c = localStorage.getItem(this.cache_data_key);
              null !== c && (a = JSON.parse(c));
            }
          }
          null === a
            ? this.get(function (a, b) {
                "" != b.options.container && b.display(a),
                  "function" == typeof b.options.callback &&
                    b.options.callback(a);
              })
            : ("" != this.options.container && this.display(a),
